...
RSpec.describe TastingsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new tasting" do

        post :create, params: {tasting: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(tasting_url(Tasting.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new tasting" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the tasting" do
        tasting = Tasting.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the tasting" do
        tasting = Tasting.create! valid_attributes
